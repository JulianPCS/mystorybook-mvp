...
const TRUST_SIGNALS = [
  { icon: "🇺🇸", text: "Printed & shipped in the U.S." },
  { icon: "🎨", text: "32 illustrated pages" },
  { icon: "👶", text: "Perfect for ages 3–8" },
  { icon: "💛", text: "Loved by families across the U.S." },
];
        ...
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-12 relative">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <p className="text-gray-500 text-lg sm:text-xl font-semibold mb-8 max-w-lg mx-auto lg:mx-0">
              Beautifully illustrated coloring books personalized for your child — celebrating their name and the moments that matter most.
            </p>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {[
              ...
              { step: "3", icon: "📦", title: "Delivered to You", desc: "A beautiful, personalized book printed and shipped across the U.S." },
            ].map((s) => (
      ...
      <section className="py-16 px-4 sm:px-6 bg-emerald-700">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-emerald-100 font-semibold mb-8 text-lg">
            Find your child&apos;s name and reserve your personalized coloring book today.
          </p>
          <Link
            href="/books"
