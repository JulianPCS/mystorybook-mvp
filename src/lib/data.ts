...
export const NAMES: BookEntry[] = [
  ...
  { slug: "zara", name: "Zara", type: "name", community: "muslim", coverAccent: "bg-purple-200", emoji: "⭐" },
  // Muslim/Arabic — top 10 UK boys
  { slug: "muhammad", name: "Muhammad", type: "name", community: "muslim", coverAccent: "bg-teal-300", emoji: "🌙" },
  { slug: "adam", name: "Adam", type: "name", community: "muslim", coverAccent: "bg-green-200", emoji: "🌿" },
  { slug: "ali", name: "Ali", type: "name", community: "muslim", coverAccent: "bg-blue-200", emoji: "🦁" },
  { slug: "ibrahim", name: "Ibrahim", type: "name", community: "muslim", coverAccent: "bg-indigo-200", emoji: "⭐" },
  { slug: "musa", name: "Musa", type: "name", community: "muslim", coverAccent: "bg-blue-200", emoji: "💧" },
  { slug: "yahya", name: "Yahya", type: "name", community: "muslim", coverAccent: "bg-green-200", emoji: "🌿" },
  { slug: "yusuf", name: "Yusuf", type: "name", community: "muslim", coverAccent: "bg-teal-300", emoji: "⭐" },
  { slug: "omar", name: "Omar", type: "name", community: "muslim", coverAccent: "bg-amber-200", emoji: "📚" },
  { slug: "ahmad", name: "Ahmad", type: "name", community: "muslim", coverAccent: "bg-blue-300", emoji: "🌙" },
  { slug: "ayaan", name: "Ayaan", type: "name", community: "muslim", coverAccent: "bg-amber-200", emoji: "🌅" },
...
export const OCCASIONS: BookEntry[] = [
  ...
  { slug: "my-first-christmas", name: "My First Christmas", type: "occasion", coverAccent: "bg-red-300", emoji: "⭐", occasionLabel: "Christmas" },
  { slug: "my-first-hanukkah", name: "My First Hanukkah", type: "occasion", coverAccent: "bg-blue-300", emoji: "✨", occasionLabel: "Hanukkah" },
  { slug: "my-first-birthday", name: "My First Birthday", type: "occasion", coverAccent: "bg-pink-300", emoji: "🎂", occasionLabel: "Birthday" },
  { slug: "big-brother", name: "Big Brother", type: "occasion", coverAccent: "bg-blue-200", emoji: "🦁", occasionLabel: "Family" },
  { slug: "big-sister", name: "Big Sister", type: "occasion", coverAccent: "bg-purple-200", emoji: "🦋", occasionLabel: "Family" },
  { slug: "starting-school", name: "Starting School", type: "occasion", coverAccent: "bg-green-200", emoji: "🎒", occasionLabel: "Milestone" },
];
