...
export const NAMES: BookEntry[] = [
  ...
  { slug: "ayaan",    name: "Ayaan",    type: "name", gender: "male", community: "muslim", coverAccent: "bg-amber-200",  emoji: "🌅", coverImage: "/covers/ayaan.png",    listed: true },
  ...
  // American — Top 20 Girls (SSA)
  { slug: "olivia",    name: "Olivia",    type: "name", gender: "female", community: "american", coverAccent: "bg-purple-200", emoji: "🌿",  listed: true },
  { slug: "emma",      name: "Emma",      type: "name", gender: "female", community: "american", coverAccent: "bg-rose-200",   emoji: "🌸",  listed: true },
  { slug: "charlotte", name: "Charlotte", type: "name", gender: "female", community: "american", coverAccent: "bg-amber-200",  emoji: "👑",  listed: true },
  { slug: "sophia",    name: "Sophia",    type: "name", gender: "female", community: "american", coverAccent: "bg-pink-200",   emoji: "🦋",  listed: true },
  { slug: "isabella",  name: "Isabella",  type: "name", gender: "female", community: "american", coverAccent: "bg-red-200",    emoji: "🌺",  listed: true },
  { slug: "ava",       name: "Ava",       type: "name", gender: "female", community: "american", coverAccent: "bg-teal-200",   emoji: "⭐",  listed: true },
  { slug: "evelyn",    name: "Evelyn",    type: "name", gender: "female", community: "american", coverAccent: "bg-indigo-200", emoji: "🌙",  listed: true },
  { slug: "harper",    name: "Harper",    type: "name", gender: "female", community: "american", coverAccent: "bg-green-200",  emoji: "🎵",  listed: true },
  { slug: "camila",    name: "Camila",    type: "name", gender: "female", community: "american", coverAccent: "bg-orange-200", emoji: "🌻",  listed: true },
  { slug: "gianna",    name: "Gianna",    type: "name", gender: "female", community: "american", coverAccent: "bg-pink-200",   emoji: "🌹",  listed: true },
  { slug: "elizabeth", name: "Elizabeth", type: "name", gender: "female", community: "american", coverAccent: "bg-blue-200",   emoji: "👑",  listed: true },
  { slug: "eleanor",   name: "Eleanor",   type: "name", gender: "female", community: "american", coverAccent: "bg-teal-100",   emoji: "🕊️", listed: true },
  { slug: "ella",      name: "Ella",      type: "name", gender: "female", community: "american", coverAccent: "bg-yellow-200", emoji: "🌼",  listed: true },
  { slug: "abigail",   name: "Abigail",   type: "name", gender: "female", community: "american", coverAccent: "bg-pink-200",   emoji: "🦋",  listed: true },
  { slug: "avery",     name: "Avery",     type: "name", gender: "female", community: "american", coverAccent: "bg-teal-200",   emoji: "🌸",  listed: true },
  { slug: "scarlett",  name: "Scarlett",  type: "name", gender: "female", community: "american", coverAccent: "bg-red-200",    emoji: "🌺",  listed: true },
  { slug: "emily",     name: "Emily",     type: "name", gender: "female", community: "american", coverAccent: "bg-purple-200", emoji: "🌸",  listed: true },
  { slug: "penelope",  name: "Penelope",  type: "name", gender: "female", community: "american", coverAccent: "bg-indigo-200", emoji: "🦋",  listed: true },
  { slug: "chloe",     name: "Chloe",     type: "name", gender: "female", community: "american", coverAccent: "bg-green-200",  emoji: "🌿",  listed: true },
  { slug: "riley",     name: "Riley",     type: "name", gender: "female", community: "american", coverAccent: "bg-amber-200",  emoji: "⭐",  listed: true },
  // American — Top 20 Boys (SSA)
  { slug: "liam",      name: "Liam",      type: "name", gender: "male", community: "american", coverAccent: "bg-blue-200",   emoji: "🦁",  listed: true },
  { slug: "james",     name: "James",     type: "name", gender: "male", community: "american", coverAccent: "bg-teal-200",   emoji: "🦊",  listed: true },
  { slug: "elijah",    name: "Elijah",    type: "name", gender: "male", community: "american", coverAccent: "bg-indigo-200", emoji: "⭐",  listed: true },
  { slug: "william",   name: "William",   type: "name", gender: "male", community: "american", coverAccent: "bg-blue-200",   emoji: "🐻",  listed: true },
  { slug: "benjamin",  name: "Benjamin",  type: "name", gender: "male", community: "american", coverAccent: "bg-amber-200",  emoji: "🐝",  listed: true },
  { slug: "lucas",     name: "Lucas",     type: "name", gender: "male", community: "american", coverAccent: "bg-green-200",  emoji: "🦎",  listed: true },
  { slug: "henry",     name: "Henry",     type: "name", gender: "male", community: "american", coverAccent: "bg-teal-200",   emoji: "🐢",  listed: true },
  { slug: "alexander", name: "Alexander", type: "name", gender: "male", community: "american", coverAccent: "bg-blue-200",   emoji: "🦅",  listed: true },
  { slug: "mason",     name: "Mason",     type: "name", gender: "male", community: "american", coverAccent: "bg-amber-200",  emoji: "🏔️", listed: true },
  { slug: "ethan",     name: "Ethan",     type: "name", gender: "male", community: "american", coverAccent: "bg-teal-200",   emoji: "🌊",  listed: true },
  { slug: "daniel",    name: "Daniel",    type: "name", gender: "male", community: "american", coverAccent: "bg-blue-200",   emoji: "🦁",  listed: true },
  { slug: "jacob",     name: "Jacob",     type: "name", gender: "male", community: "american", coverAccent: "bg-green-200",  emoji: "🐺",  listed: true },
  { slug: "logan",     name: "Logan",     type: "name", gender: "male", community: "american", coverAccent: "bg-indigo-200", emoji: "🐺",  listed: true },
  { slug: "jackson",   name: "Jackson",   type: "name", gender: "male", community: "american", coverAccent: "bg-blue-200",   emoji: "🦊",  listed: true },
  { slug: "sebastian", name: "Sebastian", type: "name", gender: "male", community: "american", coverAccent: "bg-purple-200", emoji: "🎵",  listed: true },
  { slug: "jack",      name: "Jack",      type: "name", gender: "male", community: "american", coverAccent: "bg-teal-200",   emoji: "⚓",  listed: true },
  { slug: "aiden",     name: "Aiden",     type: "name", gender: "male", community: "american", coverAccent: "bg-amber-200",  emoji: "🌅",  listed: true },
  { slug: "owen",      name: "Owen",      type: "name", gender: "male", community: "american", coverAccent: "bg-green-200",  emoji: "🦉",  listed: true },
  { slug: "samuel",    name: "Samuel",    type: "name", gender: "male", community: "american", coverAccent: "bg-amber-200",  emoji: "📚",  listed: true },
  { slug: "matthew",   name: "Matthew",   type: "name", gender: "male", community: "american", coverAccent: "bg-blue-200",   emoji: "⭐",  listed: true },
  // African
...
export const OCCASIONS: BookEntry[] = [
  ...
  { slug: "my-first-hanukkah",   name: "My First Hanukkah",   type: "occasion", occasionGroup: "festival",  coverAccent: "bg-blue-300",   emoji: "✨", occasionLabel: "Hanukkah",  coverImage: "/covers/my-first-hanukkah.png",  listed: true },
  // Milestones
